...
describe('User Service', () => {
    ...
    describe('getAllUsers', () => {
        it('should return all users', async () => {
            const users = [
                { user_id: 1, name: 'John Doe', username: 'john_doe', email: 'john@example.com', password: 'password123', role: 'admin' },
                { user_id: 2, name: 'Jane Doe', username: 'john_doe', email: 'jane@example.com', password: 'password123', role: 'user' },
            ];
    ...
    describe('getUserById', () => {
        it('should return a user by id', async () => {
            const user = { user_id: 1, name: 'John Doe', username: 'john_doe', email: 'john@example.com', password: 'password123', role: 'admin' };
    ...
    describe('updateUser', () => {
        it('should update a user', async () => {
            const user = { user_id: 1, name: 'John Doe', username: 'john_doe', email: 'john@example.com', password: 'password123', role: 'admin', update: jest.fn().mockResolvedValue({ user_id: 1, name: 'John Updated', username: 'john_doe', email: 'john@example.com', password: 'password123', role: 'admin' }) };
            (User.findByPk as jest.Mock).mockResolvedValue(user);
            ...
            expect(result).toEqual({ user_id: 1, name: 'John Updated', username: 'john_doe', email: 'john@example.com', password: 'password123', role: 'admin' });
        ...
        it('should throw an error if updating fails', async () => {
            const user = { user_id: 1, name: 'John Doe', username: 'john_doe', email: 'john@example.com', password: 'password123', role: 'admin', update: jest.fn().mockRejectedValue(new Error('Failed to update user')) };
            (User.findByPk as jest.Mock).mockResolvedValue(user);
    ...
    describe('deleteUser', () => {
        it('should delete a user', async () => {
            const user = { user_id: 1, name: 'John Doe', username: 'john_doe', email: 'john@example.com', password: 'password123', role: 'admin', destroy: jest.fn().mockResolvedValue(null) };
            (User.findByPk as jest.Mock).mockResolvedValue(user);
